...
module Rouge
  module Lexers
    ...
    class Solidity < RegexLexer
      title "Solidity"
      desc "Solidity, the blockchain language"
      ...
      def self.keywords
        @keywords ||= Set.new %w(
          ...
          eval arguments await pragma using indexed
        )
      end
      ...
      def self.declarations
        @declarations ||= Set.new %w(
          ...
          string int uint int8 uint8 int16
          uint16 int32 uint32 int64 uint64
          int128 uint128 int256 uint256 bool
          struct mapping address
          modifier event external internal
          memory storage
      ...
      def self.reserved
        @reserved ||= Set.new %w(
          ...
          contract library internal constant
        )
      end
